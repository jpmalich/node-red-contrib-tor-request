...
module.exports = function (RED) {
  ...
  function HTTPRequest(n) {
    ...
    this.on("input", function (msg) { 
      ...
      // Get Tor settings and set address
      this.useTor = n.usetor || msg.payload.useTor || false;
      this.torIp = n.torip || msg.payload.torIp || "127.0.0.1";
      this.torPort = n.torport || msg.payload.torPort || 9050;
 
      tr.setTorAddress(this.torIp,this.torPort);
      ...
      // Use Tor Request function if useTor is set
      if (this.useTor){request = tr.request;}
